...
export default function NavCenter() {
  return (
    <div className='flex flex-row'>
        <button className="flex flex-row items-center justify-center border-2 border-purpleH bg-purpleH rounded-xl mx-3 p-1">
            <img src={LinksImg} alt=""/>
            <h3 className="text-purple font-bold font-iSans">Links</h3>
        </button>
        <button className="flex flex-row items-center justify-center bg-lightPurple border-borders rounded-xl p-2">
